...
<div class="vstack gap-3">
    @if(!isset($order))
        ...
        <div id="individual_customer_section" style="display: none;">
            <div class="row">
                <div class="col-md-6">
                    <x-input-label for="customer_name" value="{{ __('customers.name') }} *"/>
            ...
            <div class="row">
                <div class="col-md-6">
                    <x-input-label for="customer_email" value="{{ __('customers.email') }}"/>
                ...
                <div class="col-md-6">
                    <x-input-label for="customer_phone" value="{{ __('customers.phone') }}"/>
    ...
    @else
        ...
        <div class="alert alert-info">
            ...
            @if($order->customer->formatted_address)
                {!! nl2br(e($order->customer->formatted_address)) !!}
            @endif
        </div>
    @endif
