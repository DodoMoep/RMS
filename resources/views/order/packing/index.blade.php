                ...
                <tbody>
                    @forelse($orders as $order)
                        @php
                            ...
                            } elseif ($packedItems === $totalItems && $totalItems > 0) {
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="progress flex-grow-1 me-2" style="height: 20px;">
                                        <div class="progress-bar {{ $progressBarClass }}" role="progressbar" style="width: {{ $percentage }}%" aria-valuenow="{{ $percentage }}" aria-valuemin="0" aria-valuemax="100">{{ $packedItems }}/{{ $totalItems }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-end">
