...
<body>
    <div class="top-section">
        <div class="recipient-side">
            ...
            <div class="recipient-box">
                ...
                @endif
                @if($order->customer->zip_code || $order->customer->city)
                    <div>{{ $order->customer->zip_code }} {{ $order->customer->city }}</div>
                @endif
                @if($order->customer->address_notes)
                    <div>{{ $order->customer->address_notes }}</div>
                @endif
    ...
    <div class="date-line">
        <strong>Datum:</strong> {{ $order->delivery_date->format('d.m.Y') }}<br>
        <strong>Art:</strong> {{ $order->delivery_type === 'delivery' ? 'Lieferung' : 'Abholung' }}
    </div>
